...
export const Navbar = () => {
  ...
  return (
    <nav
  className="relative flex flex-col gap-4 items-center justify-center w-11/12 mx-auto mt-10 text-white xl:max-w-[1200px]"
>
  <ul
    className="bg-primary-orange hidden md:flex flex-row items-center gap-10 p-2 text-center text-pretty rounded-lg"
  >
...
<path d="M41.3135 6.11638L40.1558 16.533C40.0153 17.8074 39.4092 18.9851 38.4539 19.8402C37.4986 20.6953 36.2612 21.1676 34.9791 21.1666H13.7083C12.3275 21.1649 11.0037 20.6157 10.0273 19.6393C9.05088 18.6629 8.50161 17.3391 8.49996 15.9583V5.54158C8.49902 4.71307 8.16948 3.91876 7.58363 3.33291C6.99778 2.74706 6.20347 2.41752 5.37496 2.41659H1.20829C0.932025 2.41659 0.667074 2.30684 0.471723 2.11149C0.276373 1.91614 0.166626 1.65119 0.166626 1.37492C0.166626 1.09865 0.276373 0.8337 0.471723 0.638349C0.667074 0.442999 0.932025 0.333252 1.20829 0.333252H5.37496C6.75579 0.334906 8.07959 0.884171 9.05598 1.86056C10.0324 2.83696 10.5816 4.16076 10.5833 5.54158V15.9583C10.5842 16.7868 10.9138 17.5811 11.4996 18.1669C12.0855 18.7528 12.8798 19.0823 13.7083 19.0833H34.9791C35.7484 19.0838 36.4907 18.8004 37.0639 18.2873C37.637 17.7742 38.0005 17.0676 38.0848 16.303L39.2422 5.88638C39.2905 5.44961 39.2463 5.00758 39.1124 4.58905C38.9785 4.17052 38.758 3.78487 38.4652 3.45721C38.1736 3.12789 37.815 2.86469 37.4134 2.68522C37.0118 2.50575 36.5765 2.41416 36.1366 2.41659H17.875C17.5987 2.41659 17.3337 2.30684 17.1384 2.11149C16.943 1.91614 16.8333 1.65119 16.8333 1.37492C16.8333 1.09865 16.943 0.8337 17.1384 0.638349C17.3337 0.442999 17.5987 0.333252 17.875 0.333252H36.1366C36.869 0.333464 37.5932 0.488098 38.2618 0.787064C38.9304 1.08603 39.5285 1.52261 40.017 2.06832C40.5055 2.61403 40.8734 3.2566 41.0968 3.95411C41.3202 4.65163 41.3941 5.38841 41.3135 6.11638Z" fill="white"/>
  ...
  className={`bg-primary-orange buttonHome w-max p-3 md:hidden mb-2 ${showFiltersState === 'true' ? 'z-0' : 'z-[9999999999]'} rounded-full  ${homeOpen ? 'bg-primary-bue' : 'bg-primary-orange'} `}>
    {/* SVG HOME */}
  <svg width="24" height="24" viewBox="0 0 20 20"><path fill="#FFFFFF" d="M18.178 11.373a.7.7 0 0 1 .7.7v5.874c.027.812-.071 1.345-.434 1.68c-.338.311-.828.4-1.463.366H3.144C2.5 19.961 2 19.7 1.768 19.173c-.154-.347-.226-.757-.226-1.228v-5.873a.7.7 0 0 1 1.4 0v5.873q.002.349.07.562l.036.098l-.003-.01c.001-.013.03-.008.132-.002h13.84c.245.014.401 0 .456-.001l.004-.001c-.013-.053.012-.27 0-.622v-5.897a.7.7 0 0 1 .701-.7M10.434 0c.264 0 .5.104.722.297l8.625 8.139a.7.7 0 1 1-.962 1.017l-8.417-7.944l-9.244 7.965a.7.7 0 0 1-.915-1.06L9.689.277l.086-.064c.214-.134.428-.212.66-.212"/></svg>
  </button>
  <ul className={`fixed inset-0 w-full h-full bg-primary-orange ${homeOpen ? 'homeOpen' : 'homeClose'} flex flex-col items-center justify-center gap-16 z-[99999999] transition-all duration-[400ms] font-zenMaru text-2xl`}>
  ...
  <button 
  className='bg-primary-orange hidden md:block absolute top-0 right-10 w-max p-2 rounded-lg '>
  {/* SVG USER */}
  <svg width="24" height="24" viewBox="0 0 24 24"><path fill="#FFFFFF" d="M7.5 6.5C7.5 8.981 9.519 11 12 11s4.5-2.019 4.5-4.5S14.481 2 12 2S7.5 4.019 7.5 6.5M20 21h1v-1c0-3.859-3.141-7-7-7h-4c-3.86 0-7 3.141-7 7v1z"/></svg>
